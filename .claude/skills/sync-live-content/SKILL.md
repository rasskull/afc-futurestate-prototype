...
|---|---|---|---|
| `home` | `/` | `src/pages/Home/Home.jsx` | `AudienceRouting.jsx`, `DonateInline.jsx` and `DonateFooter.jsx` (see deliberate deviations below — **not** `SignupInline.jsx`/`SignupFooter.jsx`, neither of which is used on this page anymore) |
